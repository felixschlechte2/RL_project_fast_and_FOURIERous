...
parser.add_argument('--automatic_entropy_tuning', type=bool, default=True, metavar='G', #HERE
...
for i_episode in itertools.count(1):
    ...
    if ELO_activation:
        Elos[8], Elos[current_opp] = Elo(Elos[8],Elos[current_opp], (info["winner"]+1)/2) #here
