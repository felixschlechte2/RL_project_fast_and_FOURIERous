...
class SACEncoder(nn.Module):
    def __init__(self,dim, block_type, num_blocks, hidden_dim):
        super().__init__()
        self.dim = dim
...
class SACActor(nn.Module):
    def __init__(self,dim, block_type, num_blocks, hidden_dim, action_dim,action_space=None):
        super().__init__()
...
class SACClippedDoubleCritic(nn.Module):
    def __init__(self,dim, block_type, num_blocks, hidden_dim, num_qs=2):
        super().__init__()
        self.q_networks = nn.ModuleList([
            SACCritic(dim,block_type, num_blocks, hidden_dim)
