...
qr_sac_path = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC5/checkpoints/checkpoint_hockey_vs_sac_and_strong_all_rew_ep_{version}_qr_sac_run5"
...
print(play(sac, strong_opp, 5, True, elos, "SAC_strong", 'strong_opp'))
