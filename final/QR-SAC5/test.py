...
qr_sac_runx2 = QRSAC(env.observation_space.shape[0], action_space_p1, args)
qr_sac_run5 = QRSAC(env.observation_space.shape[0], action_space_p1, args)
...
qr_sac_moe_path = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC-MoE/checkpoints/checkpoint_hockey_vs_random_all_rew_ep_6000_qr_sac_moe_run2"
sac_8400_path = models_path + fr"QR-SAC5/old_models/sac_run3"

qr_sac_runx_path = models_path + fr"QR-SAC5/checkpoints/checkpoint_hockey_vs_4_all_rew_ep_90000_qr_sac_runx"
qr_sac_runx2_path = models_path + fr"QR-SAC5/checkpoints/checkpoint_hockey_vs_4_all_rew_ep_30000_qr_sac_runx"
...
# players = [sac_strong, ac, weak_opp, strong_opp]
...
print(play(qr_sac_runx, qr_sac_runx2, 10, True, elos, "SAC_strong", 'strong_opp'))

# for i in range(10000, 40001, 10000):
#     path = models_path + fr"QR-SAC5/checkpoints/checkpoint_hockey_vs_self_and_sac_strong_all_rew_ep_{i}_qr_sac_run6"
#     qr_sac.load_checkpoint(path, True)
#     print(f"version: {i}")
#     print("strong opponent:")
#     print(play(qr_sac, strong_opp, 10, False, elos, "SAC_strong", 'strong_opp'))
#     print("sac strong:")
#     print(play(qr_sac, sac_strong, 10, False, elos, "SAC_strong", 'strong_opp'))
...
players = [qr_sac_runx, qr_sac_runx2, qr_sac_run5, qr_sac_run6, sac, sac_strong, weak_opp, strong_opp]
players_names = ["qr_sac_runx", "qr_sac_runx2", "qr_sac_run5", "qr_sac_run6", "sac", "sac_strong", "weak_opp", "strong_opp"]

# p = "./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC5/games/"
# p2 = p + "1.pkl"

# with open(p2, "rb") as f:
#     a = pkl.load(f)

# print(a["observations_round_0"])
# models_path = "./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/"
