...
player2 = h_env.BasicOpponent(weak = False) #here
...
for i_episode in itertools.count(1):
    ...
    while not done:
        if args.start_steps > total_numsteps:
            ...
            #action_opp = player2.act(obs_agent2) #here
            action_opp = np.random.uniform(-1,1,4) #here
        ...
        obs_agent2 = env.obs_agent_two()  #here
    ...
    if i_episode % 10 == 0: # hier diese Zeile
        print("Episode: {}, total numsteps: {}, episode steps: {}, score: {}".format(i_episode, total_numsteps, episode_steps, score)) #score instead of reward
        log("Episode: {}, total numsteps: {}, episode steps: {}, score: {}".format(i_episode, total_numsteps, episode_steps, score)) #score instead of reward
    ...
    if i_episode % test_interval == 0 and args.eval is True:
        ...
        for _  in range(episodes):
            ...
            #desired_dict = {"desired_goal":[4, 2.75, 5.25]} #here added for her
            desired_dict = {"desired_goal":[4, 4]} #here added for her
            #while not done: #here
            for i in range(500): #here
                env.render()
