...
sac_8400_path = r"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC/sac_checkpoint_hockey_vs_rand_all_rew_ep_8400"
version = 5700
sac_strong_path = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/SAC2_hockey_strong/checkpoints/sac_checkpoint_hockey_vs_strong_and_self_all_rew_ep_{version}"
qr_sac_path3 = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC2/checkpoints/qr_sac_checkpoint_hockey_vs_random_all_rew_ep_{version}_N_STEPS7_alpha0.1_quant16_bs1024_up_ep10"
qr_sac_path2 = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC2/checkpoints/qr_sac_checkpoint_hockey_vs_random_all_rew_ep_{version}_N_STEPS7_alpha0.01_quant32_bs1024_up_ep300"

######################## turnier: 
qr_sac.load_checkpoint(qr_sac_path3, True)
...
print(play(qr_sac, "random", 10, True, elos, "SAC_strong", 'strong_opp'))
