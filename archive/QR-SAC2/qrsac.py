...
class QRSAC(object):
    ...
    def save_checkpoint(self, env_name, args, suffix="", ckpt_path=None):
        ...
        if ckpt_path is None:
            ckpt_path = "checkpoints/qr_sac_checkpoint_{}_{}_N_STEPS{}_alpha{}_quant{}_bs{}_up_ep{}".format(env_name, suffix, 
                                                                                                            args.trajectory_length, args.alpha, args.num_quantile, args.batch_size, 
