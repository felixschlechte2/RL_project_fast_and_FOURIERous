...
def main():
    ...
    q_agent.restore_state(torch.load("./results/DQN_reward_6.pth",weights_only=True))
    ...
    print(score)
        ...
        #    torch.save(q_agent.state(), f'./results/DQN_{"hockey"}_defending_{i}-eps{eps}-t{train_iter}-l{lr}.pth')
        #    save_statistics()
