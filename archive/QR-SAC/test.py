...
qr_sac_path = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC/checkpoints/sac_checkpoint_hockey_vs_random_all_rew_ep_{version}"
...
print(play(qr_sac, "random", 2, True, elos, "SAC_strong", 'strong_opp'))
