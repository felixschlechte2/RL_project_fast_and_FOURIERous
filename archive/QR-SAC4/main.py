...
def save_statistics(i_episode, episode_reward):
    with open(f"./runs/stats_{args.env_name}-{run_name}.pkl", 'wb') as f: # ./ReinforcementLearning/ExcercisesGitHub/exercises mit venv/project_code/models/DDPG
        pkl.dump({"episode" : i_episode, "reward_per_epsisode": episode_reward}, f)
...
for i_episode in itertools.count(5701): # hier 1
