...
args_path = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC4/run_info/qr_sac_run4_args.pkl"
...
qr_sac_path = fr"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/QR-SAC4/checkpoints/checkpoint_hockey_vs_random_all_rew_ep_{version}_qr_sac_run4"
...
# print(play(qr_sac, strong_opp, 20, True, elos, "SAC_strong", 'strong_opp'))
