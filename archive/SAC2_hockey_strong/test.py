...
sac_8400_path = r"./Reinforcement Learning/ExcercisesGitHub/exercises mit venv/project_code/models/SAC2_hockey_strong/sac_checkpoint_hockey_vs_rand_all_rew_ep_8400"
version = 35000
...
######################## turnier: 
ac.load_checkpoint(sac_8400_path, True)
...
# print(play(sac_strong, strong_opp, 5, True, elos, "SAC_strong", 'strong_opp'))
...
#         # if i % 1000 == 0: print(i)
#         env.render(mode="human")
#         action_agent = ac.select_action(obs, True)[:4]  # Sample action from policy
#         # print(action_agent)
